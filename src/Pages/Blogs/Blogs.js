...
const Blogs = () => {
    return (
        <div className='m-5'>
            <h2 className='text-center text-info bg-dark m-5'>Difference between authorization and authentication?</h2>
            ...
            <h2 className='text-center text-info bg-dark m-5'>Why are you using firebase? What other options do you have to implement authentication?</h2>
            ...
            <h2 className='text-center text-info bg-dark m-5'>What other services does firebase provide other than authentication?</h2>
